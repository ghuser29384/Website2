...
function Directory({ records }: { records: EvidenceRecord[] }) {
  return (
    <>
      ...
      <section className="pe-section">
        <div className="pe-section-head"><div><p>Interface example · not a live trade</p><h2>Evidence review</h2></div></div>
        <article className="pe-example">
          <div className="pe-example-copy">
            ...
            <Link href="/evidence/example">Open the evidence viewer →</Link>
          </div>
