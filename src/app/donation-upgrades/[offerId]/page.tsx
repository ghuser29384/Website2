    ...
    <div className="page-shell">
      <header className="hero">
        ...
        <PageHero
          ...
          )} to ${displayOffer.original_recipient.name}. With a match, ${formatDirectDonationUpgradeUsd(
            displayOffer.retained_amount_cents,
          )} remains there, ${formatDirectDonationUpgradeUsd(
            displayOffer.redirected_amount_cents,
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        >
          ...
          <div className="concept-grid">
            ...
            <article className="panel concept-card">
              ...
              <p>
                ...
                with {displayOffer.original_recipient.name} and redirects{" "}
                {formatDirectDonationUpgradeUsd(
                  displayOffer.redirected_amount_cents,
                )}{" "}
          ...
          <dl className="detail-grid">
            ...
            <div>
              <dt>Counteroffers</dt>
              <dd>{publicOffer?.proposal_count ?? proposals.length}</dd>
            </div>
            <div>
        ...
        >
          ...
          >
            Accepting current terms selects the primary matcher immediately.
            A counteroffer is not a chat message: it freezes a proposed redirect
            percentage and matcher amount, and becomes a matcher commitment only
            if the creator accepts it.
          </SectionHeader>
        ...
        {isCreator && proposals.length ? (
          ...
          >
            ...
            >
              ...
              matched revision and direct donation obligations. Rejecting it
              may include a short response so the proposer can revise.
            </SectionHeader>
        ...
        {detail.isParticipant ? (
          ...
          >
            ...
            >
              ...
              backup matchers, and negotiating counterparties.
            </SectionHeader>
            <div className="data-grid">
