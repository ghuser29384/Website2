...
function parsePayload(payload: unknown) {
  ...
  return {
    ...
    dualControlApproverId: readString(record, "dualControlApproverId") ?? readString(record, "approverId"),
...
export async function POST(request: Request, { params }: { params: Promise<{ milestoneId: string }> }) {
  ...
  try {
    ...
    const decision = buildDemoMpgfPublicGoodsMilestoneReleaseDecision({
      ...
      dualControlApproverId: payload.dualControlApproverId,
    ...
    return NextResponse.json(
      {
        ...
        dualControlConfirmed: result.decision.dualControlConfirmed,
