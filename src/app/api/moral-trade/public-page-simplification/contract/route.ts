...
export async function GET(request: Request) {
  ...
  return buildMoralTradeApiJsonResponse({
    ...
    publicContract: {
      ...
      publicPageDefaultShape: contract.publicPageDefaultShape,
      offersTabOrder: contract.offersTabOrder,
      signedOutOffsetPreviewSteps: contract.signedOutOffsetPreviewSteps,
      donationOffsetPlainLabelMap: contract.donationOffsetPlainLabelMap,
      validationStatusLabels: contract.validationStatusLabels,
      paidActionSafeAlternatives: contract.paidActionSafeAlternatives,
