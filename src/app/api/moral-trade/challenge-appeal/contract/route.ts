...
export async function GET(request: Request) {
  ...
  return buildMoralTradeApiJsonResponse({
    ...
    publicContract: {
      ...
      appealCaseStatuses: contract.appealCaseStatuses,
      noticeStates: contract.noticeStates,
      ...
      appealCaseSampleEvaluationStatuses: Object.fromEntries(
        contract.sampleAppealCaseEvaluations.map((evaluation) => [
