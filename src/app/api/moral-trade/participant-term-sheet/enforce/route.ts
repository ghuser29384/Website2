...
import {
  ...
  type MoralTradeParticipantTermSheetSourceKind,
...
const TERM_SHEET_SOURCE_KINDS = new Set<MoralTradeParticipantTermSheetSourceKind>([
...
const TERM_SHEET_KEYS = new Set([
  ...
  "participantFacingPlainLanguage",
  "participantFacingPrivacySafe",
  "participantFacingRenderHash",
  "participantTermHash",
  "participantTermSourceKind",
  "rawPrivateTermsPublic",
  "reviewedAt",
  "reviewerNotesPublic",
  "scopedToExactMatchedProposal",
  "internalHashHasParticipantFacingEquivalent",
  "subjectRef",
  "subjectType",
  "supersededBy",
  "termSheetId",
...
function normalizeTermSheet(
  ...
  return {
    ...
    participantFacingPlainLanguage: booleanField(
      record.participantFacingPlainLanguage,
    ),
    participantFacingPrivacySafe: booleanField(record.participantFacingPrivacySafe),
    participantFacingRenderHash: nullableHashField(
      record.participantFacingRenderHash,
      `${prefix}.participantFacingRenderHash`,
      blockers,
    ),
    ...
    participantTermSourceKind: enumField(
      record.participantTermSourceKind,
      TERM_SHEET_SOURCE_KINDS,
      "raw_json",
      `${prefix}.participantTermSourceKind`,
      blockers,
      true,
    ),
    ...
    scopedToExactMatchedProposal: booleanField(record.scopedToExactMatchedProposal),
    internalHashHasParticipantFacingEquivalent: booleanField(
      record.internalHashHasParticipantFacingEquivalent,
    ),
