        ...
        <section className="section section-subtle" aria-labelledby="trade-circles-heading">
          ...
          <div className="panel data-card data-card-wide">
            ...
            <p className="route-text">
              Existing bilateral trades, donation redirects, Common Ground Pools, and threshold
              pools retain their own supported workflows. None is relabeled as a Trade Circle.
            </p>
