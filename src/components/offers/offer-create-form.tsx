...
export function OfferCreateForm({
  ...
  const clearingPreview = isOffset
    ? buildMoralTradeClearingPreview({
        ...
        batchClearingObjectiveStatus: "needs_review",
        ...
        approvedTemplateConformanceStatus: "needs_review",
        reviewCapacityAdmissionStatus: "needs_review",
        nonPublicGoodsSubsidyStatus: "not_required_for_stage",
        riskControlPackStatus: "needs_review",
        marketSimulationStatus: "needs_review",
        optionSetParetoComparisonStatus: "needs_review",
        preferenceIncomparabilityStatus: "needs_review",
        tradeBurdenAccountingStatus: "needs_review",
        moralDifferenceAttestationStatus: "needs_review",
        bargainingProtocolStatus: "needs_review",
        empiricalAssumptionSnapshotStatus: "needs_review",
        sideConstraintStatus: "not_required_for_stage",
        intrapersonalSelfOffsetStatus: "not_required_for_stage",
        antiCorruptionProcessIntegrityStatus: clearingPreviewStatusFromGateCounts(
          donationOffsetAuthorityFairnessPreview,
        ),
    ...
    : isPledge
      ? buildMoralTradeClearingPreview({
          ...
          bargainingProtocolStatus: "needs_review",
          empiricalAssumptionSnapshotStatus: "needs_review",
          sideConstraintStatus: "needs_review",
          intrapersonalSelfOffsetStatus: "not_required_for_stage",
          antiCorruptionProcessIntegrityStatus: pledgeGateStatus(
          ...
          microPledgeControls: {
            unitBaselineStatus: pledgeGateStatus("baseline-integrity"),
            unitAdditionalityStatus: "needs_review",
            coveredFoodDefinitionStatus: "needs_review",
            adequateSubstitutePlanStatus: "needs_review",
            healthSafetyBoundaryStatus: pledgeGateStatus("health-safety-boundary"),
            prePerformanceLockStatus: "needs_review",
            retroactiveClaimStatus: "needs_review",
            evidenceLadderStatus: "needs_review",
            perUnitAmountBandStatus: "needs_review",
            sequenceCapStatus: "needs_review",
            noAutoRolloverStatus: "needs_review",
            longerDurationReviewStatus: isLongerDurationPledge(reviewPeriod)
              ? "needs_review"
              : "not_required_for_stage",
          },
        })
