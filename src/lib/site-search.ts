...
export const SITE_SEARCH_ITEMS: SiteSearchItem[] = [
  ...
  {
    href: "/trade-controls",
    label: "Safeguards by workflow",
    summary: "Find the live proposal, agreement, evidence, pool, profile, safety, or authority workflow responsible for each safeguard; the former Control simulator is retired.",
    kind: "learn",
    keywords: [
