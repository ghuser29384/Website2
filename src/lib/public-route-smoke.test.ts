...
test("offer detail and worked examples expose instrumented review workflow cards", () => {
  ...
  assert.match(offerDetailSource, /card\.assessmentLabel/);
  assert.match(offerDetailSource, /card\.assessmentReason/);
  assert.match(offerDetailSource, /How to read these screening results/);
...
test("offer creation form exposes a guided reviewable-trade wizard", () => {
  ...
  assert.match(offerForm, /card\.assessmentLabel/);
