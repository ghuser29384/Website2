...
test("background networking and reasoning routes are distinct resilient public routes", () => {
  ...
  assert.match(reasoningCenterPage, /getMoralTradeReasoningPacketFilterKey/);
  assert.match(reasoningCenterPage, /filterMoralTradeReasoningPackets/);
  assert.match(reasoningCenterPage, /getMoralTradeReasoningPacketFilterCounts/);
...
test("validation rulebook exposes reviewer roles, SLAs, conflicts, and quality metrics", () => {
  ...
  assert.match(reasoningPacketsRoute, /getMoralTradeReasoningPacketFilterKey/);
  assert.match(reasoningPacketsRoute, /filterMoralTradeReasoningPackets/);
  assert.match(reasoningPacketsRoute, /activeFilter/);
  assert.match(reasoningPacketsRoute, /filterCounts/);
