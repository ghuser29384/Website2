...
test("public guidance describes verification pipelines without custody overclaims", () => {
  ...
  assert.match(mpfgPage, /Preview Common Ground Budget/);
...
test("create trade route family has stable signed-out entry points", () => {
  ...
  assert.match(marketplaceIntakeTriage, /public_goods_module/);
...
test("marketplace pilot copy separates live offers from worked examples", () => {
  ...
  assert.match(offersPage, /Preview Common Ground Budget/);
  ...
  assert.match(mpgfPage, /Preview Common Ground Budget/);
  ...
  assert.match(offersPage, /Explore live offers, reviewed templates, worked examples, demo data, and the Public Goods Fund module/);
