...
export const MARKETPLACE_INTAKE_TRIAGE_ROUTES: MarketplaceIntakeTriageRoute[] = [
  ...
  },
  {
    ...
    label: `${MARKETPLACE_PUBLIC_GOODS_BOUNDARY.userFacingLabel} / ${MARKETPLACE_PUBLIC_GOODS_BOUNDARY.marketplaceLaneLabel}`,
    href: MARKETPLACE_PUBLIC_GOODS_BOUNDARY.href,
    status: "Separate module",
    routeEligible: false,
    routeKind: "safe_external_path",
    safeReasonCategory: "public goods fund module",
    nextAction: MARKETPLACE_PUBLIC_GOODS_BOUNDARY.marketplaceLaneCtaLabel,
