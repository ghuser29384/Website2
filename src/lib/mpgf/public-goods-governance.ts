...
export function getMpgfPublicGoodsGovernanceApi() {
  ...
  return {
    ...
    sponsorPoolFlywheel: {
      ...
      nextRoundRefillCents: sponsorPoolFlywheel.refillAutomation.availableForNextRoundCents,
      noSponsorCampaignSteering: sponsorPoolFlywheel.refillAutomation.noSponsorCampaignSteering,
