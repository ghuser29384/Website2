  ...
  const session = await getStripe().checkout.sessions.create(
    {
      ...
      success_url: `${normalizedOrigin}/donation-offsets/conditional?setup=success&offer=${input.offerId}`,
      cancel_url: `${normalizedOrigin}/donation-offsets/conditional?setup=cancelled&offer=${input.offerId}`,
