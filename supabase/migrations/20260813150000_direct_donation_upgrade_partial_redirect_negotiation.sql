...
before update or delete on public.direct_donation_upgrade_proposals
...
select
  ...
  (
    ...
    where proposal.offer_id = offer.id and proposal.status <> 'withdrawn'
  ) as proposal_count
...
revoke all on public.direct_donation_upgrade_proposals from anon, authenticated;
grant all on public.direct_donation_upgrade_proposals to service_role;
...
revoke execute on function public.create_direct_donation_upgrade_offer(uuid, text, integer, integer, timestamptz, text, jsonb, jsonb, text, text, text, integer)
  from public, anon, authenticated;
revoke execute on function public.propose_direct_donation_upgrade_terms(uuid, uuid, integer, integer, integer, integer, text, text)
  from public, anon, authenticated;
revoke execute on function public.withdraw_direct_donation_upgrade_proposal(uuid, uuid)
  from public, anon, authenticated;
revoke execute on function public.reject_direct_donation_upgrade_proposal(uuid, uuid, text)
  from public, anon, authenticated;
revoke execute on function public.accept_direct_donation_upgrade_proposal(uuid, uuid, text)
  from public, anon, authenticated;
...
grant execute on function public.create_direct_donation_upgrade_offer(uuid, text, integer, integer, timestamptz, text, jsonb, jsonb, text, text, text, integer)
  to service_role;
grant execute on function public.join_direct_donation_upgrade_offer(uuid, uuid, text)
  to service_role;
grant execute on function public.propose_direct_donation_upgrade_terms(uuid, uuid, integer, integer, integer, integer, text, text)
  to service_role;
grant execute on function public.withdraw_direct_donation_upgrade_proposal(uuid, uuid)
  to service_role;
grant execute on function public.reject_direct_donation_upgrade_proposal(uuid, uuid, text)
  to service_role;
grant execute on function public.accept_direct_donation_upgrade_proposal(uuid, uuid, text)
  to service_role;
grant execute on function public.cancel_direct_donation_upgrade_offer(uuid, uuid)
  to service_role;
