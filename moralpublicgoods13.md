# Coalition-Routed Escrowed Conditional Matching (CRECM v1.7)
...
Build **Coalition-Routed Escrowed Conditional Matching v1.7** in `moraltrade.org`.

- **Abbreviation:** CRECM
- **User-facing label:** Common Ground Budget
- **Technical label:** CRECM v1.7
...
```env
MPGF_MECHANISM_VERSION=crecm_v1_7
```
...
```text
Coalition-Routed Escrowed Conditional Matching v1.7
```
