# Coalition-Routed Escrowed Conditional Matching (CRECM v1.6)
...
Build **Coalition-Routed Escrowed Conditional Matching v1.6** in `moraltrade.org`.

- **Abbreviation:** CRECM
- **User-facing label:** Common Ground Budget
- **Technical label:** CRECM v1.6
...
Default to paying small cash bonuses from the sponsor’s failure pool, not just credit.
...
```text
Coalition-Routed Escrowed Conditional Matching v1.6
```
