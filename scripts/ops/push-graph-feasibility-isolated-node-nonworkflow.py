#!/usr/bin/env python3
"""Patch and push only non-workflow graph-feasibility files."""
...
run(
    ...
    "-m",
    "Prevent unattached records from inflating the apparent independent-cluster count and bind the updated diagnostic code and report hashes. The package remains synthetic-only and no-launch.",
)
