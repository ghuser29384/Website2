...
12. Stale, closed, dismissed, reported, or expired artifacts enter a retention lifecycle: after the participant-visible review window and any safety-review hold, candidate references and free-text content are deleted or anonymized, while only redacted/anonymized audit rows may remain.
13. Only after mutual consent and operator review can field-level grants disclose more detail.
