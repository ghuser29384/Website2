...
The implementation must preserve the repository's canonical Discover taxonomy and must not duplicate one Co-Fund as both an Offer and a standalone Pool.
