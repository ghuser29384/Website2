...
- PR #534: accounting and causal-methodology source; no active methodology.
...
- Factual fulfillment is not additionality.
- Reliability cannot create ranking, payment, restriction, or eligibility effects.
...
Before every implementation, proof, merge, release, determination submission, or recruitment step, re-read `main`, overlapping PRs, workflows, migrations, and source hashes. Material overlap requires a fresh candidate and rerun.

## Authorization boundary

This precedence record authorizes no runtime implementation, merge, migration, deployment, data access, provider action, money movement, participant contact, recruitment, consent, or research execution.
