...
- `moraltrade60.md` includes broader long-tail requirements beyond this PR slice, including live operational execution for the new production-readiness, participant-eligibility, account-security, reviewer-quality, anti-enumeration, privacy-governance, impact-claim, matching-clearing, baseline-integrity, agreement-amendment, challenge-appeal, recipient/destination, side-agreement, and trade-classification records, live lock-proposal creation jobs, live endpoint enforcement for baseline-integrity assessments before clearing, live endpoint enforcement for agreement-amendment records before post-lock material changes, live endpoint enforcement for challenge-appeal/correction records before adverse-decision correction reliance, live endpoint enforcement for privacy access logs, live endpoint enforcement for impact-claim publication records, live endpoint enforcement for anti-enumeration logs/probe audits, live endpoint enforcement for side-agreement disclosure/review records before reliance-bearing transitions, live endpoint enforcement for trade-classification and compensated-action-term records before moral-trade metric publication or payable/reliance-bearing transitions, reviewer audit sampling execution, and live deployment exercise of matching-clearing and clearing-preview execution against production Supabase/authenticated traffic.
