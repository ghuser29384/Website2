...
Draft-time account lookup and explicit selection are distinct from publication: neither operation sends an invitation, records acceptance, or enrolls the selected account.
