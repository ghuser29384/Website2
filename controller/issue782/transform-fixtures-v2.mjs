...
function campaign(id) { return `campaign-${id.replaceAll("-", "")}`; }
...
const fixture = replaceAll(`\\set ON_ERROR_STOP on\n\nbegin;\n\n${fixtureSource.slice(profileStart)}`);
const mappedCleanup = replaceAll(cleanupSource);
const authCleanupIndex = mappedCleanup.indexOf("\ndelete from auth.mfa_factors");
