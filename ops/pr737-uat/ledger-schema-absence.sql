...
select 'ledger_private_relations_before=' || private_relations from counts
union all
select 'ledger_private_functions_before=' || private_functions from counts
union all
select 'ledger_triggers_before=' || ledger_triggers from counts;
